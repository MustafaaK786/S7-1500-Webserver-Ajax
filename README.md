...
When you Navigate to _http://[PLC-IP]/awp/[ApplicationName]/[Default_HTML_Page]_ in your browser, e.g. __http://192.168.0.2/awp/AJAX/index.html__
For the fully working application with the ".dat" functionality, use the two files: index.html, and read_variables.dat. therefore, open __http://192.168.0.2/awp/AJAX/index.html__
